...
-- Pirate Perfection Reborn Trainer related Options
 ...
 -- HUD Texts
	HUD = false,											-- Set to false in order to disable ALL Pirate Perfection hud elements
	HUD_VersionText = false,							-- Displays current version of PPR in main menu
	HUD_MovingText = false,							-- Displays moving text in main menu and in game.
	RSSFeed = false,									-- Displays PiratePerfection.com RSS Feed in Main-Menu

 -- Logging Option
	LogErrorsToFile = true,							-- This will not only display PPR related errors into console, but will write them into errlog.log

 -- Secert
	no_liberty_hook = true,						-- It's a Secret that only retired developers know about.
...
-- General Options
 ...
 -- Unlocker Options
	...
	AllWeaponSkins = true,							-- Gives you all Weapon skins
 ...
 -- Lobby Options
	...
	FreeBlackMarket = true,						-- Purchase everything at no cost.
	...
	FreeCrimeSpree = true,							-- Free Crime Spree start, continue, and randomization costs.

 -- Spoof Options	
	NameSpoof = "ap0",		-- Your new name in game, set to false in order to use your steam name. Don't forget to write your name in "Quotation Marks" (V.I.P. only Function)
 ...
 -- Anticheat related Options
	...
	Hide_Pirate_Perfection = true,				-- Hides Pirate Perfection from others.
	non_modded_lobby = true,						-- Sets your Lobby to not Modded. (Pro & V.I.P. Only Function)
